...
// Then a form should be presented to the user in which the following information can be entered: DONE
...
// Then the book should be saved in the database: DONE

// *Given the database contains saved books
// When a user visits the dashboard
// Then all the books should be displayed: DONE
